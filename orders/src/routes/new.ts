...
import { BadRequestError, NotFoundError, OrderStatus, requireAuth, validationRequest } from '@k8s-demo/common';
...
async (req: Request, res: Response) => {
    ...
    // find an order where the ticket is found and the orders status is not cancelled
